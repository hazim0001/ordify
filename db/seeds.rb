...
# Sashimi
menu_item1 = MenuItem.new(title: "Shake", item_price_cents: rand(350..1090), description: "Fatty Salmon", category: Category.first, restaurant: Restaurant.last)
...
menu_item2 = MenuItem.create!(title: "Maguro", item_price_cents: rand(350..1090), description: "Yellowfin tuna", category: Category.first, restaurant: Restaurant.last)
...
menu_item3 = MenuItem.create!(title: "Hirimasa", item_price_cents: rand(350..1090), description: "Yellowtail kingfish", category: Category.first, restaurant: Restaurant.last)
...
menu_item4 = MenuItem.create!(title: "Sashimi mix", item_price_cents: rand(350..1090), description: "Salmon, yellowfin tuna and hiramasa", category: Category.first, restaurant: Restaurant.last)
...
#NIGIRI
menu_item5 = MenuItem.create!(title: "Inari", item_price_cents: rand(350..890), description: "tofu with ginger and trout roe", category: Category.second, restaurant: Restaurant.last)
...
menu_item6 = MenuItem.create!(title: "Abokado", item_price_cents: rand(350..890), description: "avocado, miso aïoli & sesame", category: Category.second, restaurant: Restaurant.last)
...
menu_item7 = MenuItem.create!(title: "Hirame", item_price_cents: rand(350..890), description: "lightly smoked halibut", category: Category.second, restaurant: Restaurant.last)
...
menu_item8 = MenuItem.create!(title: "Kinoko", item_price_cents: rand(350..890), description: "portobello mushroom & lime salt", category: Category.second, restaurant: Restaurant.last)
...
menu_item9 = MenuItem.create!(title: "Hiramasa Yaki", item_price_cents: rand(350..890), description: "eared yellowtail kingfish", category: Category.second, restaurant: Restaurant.last)
...
#Maki
menu_item10 = MenuItem.create!(title: "Ebi Panko", item_price_cents: rand(1050..1790), description: "tempura shrimp & spicy sauce, topped with avocado", category: Category.third, restaurant: Restaurant.last)
...
menu_item11 = MenuItem.create!(title: "New York Subway", item_price_cents: rand(1050..1790), description: "tempura shrimp, avocado & spicy sauce,topped with salmon & garlic", category: Category.third, restaurant: Restaurant.last)
...
menu_item12 = MenuItem.create!(title: "Shake Aïoli", item_price_cents: rand(1050..1790), description: "snow peas,avocado, miso aïoli & cucumber, topped with seared salmon & trout roe", category: Category.third, restaurant: Restaurant.last)
...
menu_item13 = MenuItem.create!(title: "Hell’s Kitchen", item_price_cents: rand(1050..1790), description: "tempura shrimp, avocado & spicy sauce, topped with tuna & barbecue", category: Category.third, restaurant: Restaurant.last)
...
menu_item14 = MenuItem.create!(title: "Ceviche", item_price_cents: rand(1050..1790), description: "pickled red onion,avocado & cucumber, topped with scallops & coriander cress", category: Category.third, restaurant: Restaurant.last)
...
menu_item15 = MenuItem.create!(title: "Rainbow", item_price_cents: rand(1050..1790), description: "shrimp & snow peas, topped with salmon, tuna, hiramasa & avocado", category: Category.third, restaurant: Restaurant.last)
...
#sticks
menu_item16 = MenuItem.create!(title: "Ramuyaki", item_price_cents: rand(350..1090), description: "Lamb chop & miso herb butter", category: Category.fourth, restaurant: Restaurant.last)
...
menu_item17 = MenuItem.create!(title: "Buta Yaki", item_price_cents: rand(350..1090), description: "Organic free-range pork with yuzu-miso", category: Category.fourth, restaurant: Restaurant.last)
...
menu_item19 = MenuItem.create!(title: "Hotate Bacon", item_price_cents: rand(350..1090), description: "Scallops & bacon with miso herb butter", category: Category.fourth, restaurant: Restaurant.last)
...
# #Salads
menu_item20 = MenuItem.create!(title: "Jungle Fish Salad", item_price_cents: rand(1050..1490), description: "Grilled salmon, shrimp and seared tuna, on a bed of green leaf salad, red cabbage, quinoa, tomatoe and avocado", category: Category.fifth, restaurant: Restaurant.last)
...
menu_item21 = MenuItem.create!(title: "Green Gate Salad", item_price_cents: rand(1050..1490), description: "Grilled sweet potato, cauliflower &  mushroom on a bed of green leaf salad, cabbage, quinoa, tomatoes, avocado", category: Category.fifth, restaurant: Restaurant.last)
...
menu_item22 = MenuItem.create!(title: "Green Bird Salad", item_price_cents: rand(1050..1490), description: "Marinated chicken and soy egg on a salad of green leaves, red cabbage, quinoa, tomatoes, edamame, radish, broccoli & sesame.", category: Category.fifth, restaurant: Restaurant.last)
...
#Sake
menu_item23 = MenuItem.create!(title: "Mio Sparkling,Takara [5%]", item_price_cents: rand(500..1090), description: "Fruity with a refreshing, sweet aroma and fine bubbles. Perfect as an aperitif.", category: Category.find_by(title: "Sake"), restaurant: Restaurant.last)
...
menu_item24 = MenuItem.create!(title: "Gok Arakuchi sake [15%]", item_price_cents: rand(500..1090), description: "Award winning warm sake. Wonderfully well balanced,classic and dry.", category: Category.find_by(title: "Sake"), restaurant: Restaurant.last)
...
menu_item25 = MenuItem.create!(title: "Tokebetsu Sake [15.5%]", item_price_cents: rand(500..1090), description: "Award winning warm sake. Wonderfully well balanced,classic and dry.", category: Category.find_by(title: "Sake"), restaurant: Restaurant.last)
...
#BEERS
menu_item26 = MenuItem.create!(title: "Asahi [5.2%]", item_price_cents: rand(350..690), description: "Brewed to the authentic Japanese recipe to deliver its dry, crisp taste and quick clean finish.", category: Category.find_by(title: "Beers"), restaurant: Restaurant.last)
...
menu_item27 = MenuItem.create!(title: "Saporo [5%]", item_price_cents: rand(350..690), description: "Japan’s most beautifully labelled beer. Smooth taste with a hint of sweetness. An excellent, easy-to-drink, modern lager", category: Category.find_by(title: "Beers"), restaurant: Restaurant.last)
...
menu_item28 = MenuItem.create!(title: "Kirin Ichiban [5%]", item_price_cents: rand(350..690), description: "chiban Shibori is a unique method of brewing beer at its purest from a single, pure ingredient: 100% malt.", category: Category.find_by(title: "Beers"), restaurant: Restaurant.last)
...
menu_item29 = MenuItem.create!(title: "Brooklyn Special [0.4%]", item_price_cents: rand(350..690), description: "Hoppy and aromatic lager style beer, full of flavour but low in alcohol content.", category: Category.find_by(title: "Beers"), restaurant: Restaurant.last)
...
#Tea
menu_item30 = MenuItem.create!(title: "Matcha Tea", item_price_cents: rand(300..550), description: "The finest leaves from the harvest of the year, ground on ancient stone grinding wheels and whipped into a smooth, frothy tea.", category: Category.find_by(title: "Tea"), restaurant: Restaurant.last)
...
menu_item31 = MenuItem.create!(title: "Sencha & Matcha", item_price_cents: rand(300..550), description: "Green tea with a fine scent of fresh grass. Perfect for sushi.This Sencha is mixed with Matcha for a deep colour and fantastic taste.", category: Category.find_by(title: "Tea"), restaurant: Restaurant.last)
...
menu_item32 =  MenuItem.create!(title: "Genmaicha Tea", item_price_cents: rand(300..550), description: "Green tea with popped rice. Mild and soft with a fine taste of nuts.", category: Category.find_by(title: "Tea"), restaurant: Restaurant.last)
...
menu_item33 = MenuItem.create!(title: "Jasmine Tea", item_price_cents: rand(300..550), description: "Green tea with an elegant taste of jasmine.", category: Category.find_by(title: "Tea"), restaurant: Restaurant.last)
...
>>>>>>> edfce8dc1b4c26c262100f8dfe994706fbc0a439
